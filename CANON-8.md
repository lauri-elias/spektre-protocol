...
## 8. Failure Mode Without CANON-8

Without this canon:

- decision-making externalizes
- responsibility dissolves
- agents wait for answers that never arrive
...
- loss of initiative
- pseudo-action without commitment
...
CANON-8 is satisfied when:

- tools stop at computation
- resolution requires explicit human commit
